...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Outside_Stalingrad&box=44.174057,49.106504,44.064281,49.034639
...
-----------
  ...
  * Outside_Stalingrad Height Map (ASTER 30m).png
  ...
  * Outside_Stalingrad Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Outside_Stalingrad Height Map (SRTM3 v4.1).png
  ...
  * Outside_Stalingrad Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 11m (actual) is equal to 40m in
